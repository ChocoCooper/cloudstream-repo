...
object VidlinkExtractor {
    ...
    // Exact trusted User-Agent to bypass firewall precondition checks
    ...
    suspend fun getStreams(
        ...
        return try {
            // 1. Fetch decrypted token natively
            ...
            if (linksFound) {
                // Wrap the MP4 in a local M3U8 manifest. 
                // This forces ExtractorLinkType.M3U8, which completely stops Cloudstream from
                // launching the `PreviewImgMp4` thumbnail spam that was causing your 429 IP Ban.
