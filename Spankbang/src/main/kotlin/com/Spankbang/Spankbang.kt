...
class Spankbang : MainAPI() {
    ...
    override val mainPage = mainPageOf(
            ...
            "${mainUrl}/60/channel/puretaboo/" to "Pure Taboo",
            "${mainUrl}/1q/channel/daddy4k/" to "Daddy 4K",
            "${mainUrl}/47/channel/vixen/" to "Vixen",
            "${mainUrl}/2c/channel/blacked/" to "Blacked",
            "${mainUrl}/49/channel/deeper/" to "Deeper",
            "${mainUrl}/46/channel/tushy/" to "Tushy",
            "${mainUrl}/ci/channel/nubile+films/" to "Nubile Films",
            "${mainUrl}/97/channel/zero+tolerance+films/" to "Zero Tolerance Films",
    )
